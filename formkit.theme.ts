...
/**
  ...
  *
  * @checksum - 11c3782fb993494dcc4e03a0ca8fa11095fae076def1e4879099eb41340c86a0
  * @variables - radius=rounded-lg,accentColor=blue,colorTemperature=neutral,spacing=1.5,scale=base,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-[20em],tagRadius=rounded,swatchRadius=rounded
  * @theme - regenesis
  **/
...
const globals: Record<string, Record<string, boolean>> = {
	outer: {
		'group': true,
		'max-w-[20em]': false, // troquei para false
		'min-w-0': true,
		'grow': true,
		'mb-3.5': true,
		'data-[disabled]:select-none': true,
